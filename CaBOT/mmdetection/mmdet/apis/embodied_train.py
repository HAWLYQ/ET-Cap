...
def train_navigator(model,
    ...
    # print('mmdet/apis/embodied_train.py train_loader_cfg:', train_loader_cfg)
    ...
    # optimizer = torch.optim.AdamW(params=model.parameters(), lr=0.0001, weight_decay=0.0001,)
    ...
    if validate:
        ...
        # print('mmdet/apis/embodied_train.py val_loader_cfg:', val_dataloader_args)
        # exit(0)
...
def train_captioner(model,
    ...
    # cfg.data.get('train_dataloader', {}) will rewrite samples_per_gpu and workers_per_gpu
    train_loader_cfg = {
        **train_dataloader_default_args,
        **cfg.data.get('train_dataloader', {})
    }
