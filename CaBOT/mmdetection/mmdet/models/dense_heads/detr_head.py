...
class DETRHead(AnchorFreeHead):
    ...
    def forward_train(self,
        ...
        # print('models/dense_heads/detr_head.py outs:', outs)
        # print('models/dense_heads/detr_head.py gt_bboxes:', gt_bboxes)
        # print('models/dense_heads/detr_head.py gt_labels:', gt_labels)
